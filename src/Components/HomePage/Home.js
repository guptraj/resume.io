    ...
    return (
        <div style={{minWidth:'300px'}}>
            ...
            <div className='d-flex justify-content-center mt-5' >
                ...
                <h1 className='p-2 rounded text-white  ' >Select a Template to get started!</h1>
            </div>
                    ...
                    {templateImagesPaths.map((currentTemplate)=>{
                            return(
                                <div className='col col-lg-3 col-md-6  col-12 mt-5' key={shortid.generate()}>
                                    ...
                                    >
                                    <div className='w-100 d-flex justify-content-center text-white'><h3>{currentTemplate.name}</h3></div>
